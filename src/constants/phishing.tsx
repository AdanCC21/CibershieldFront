    ...
    content: [
        {
            ...
            child: <ModalInfoContent title="¿Que es el phishing por correo?" p1="El phishing es una técnica de fraude en línea que utiliza correos electrónicos, mensajes de texto o sitios web falsos para engañar a los usuarios y hacer que revelen información personal, como contraseñas, números de tarjetas de crédito o datos bancarios. Los atacantes suelen disfrazarse como entidades legítimas, como bancos o servicios en línea, para ganar la confianza del usuario." p2="El objetivo principal del phishing es robar información sensible para realizar fraudes financieros o comprometer la seguridad de las cuentas del usuario." src="/phishing/you_identify.webp" />
        },
        {
            id: 1,
            icon: Icons.sms,
            ...
            child: <ModalInfoContent title="¿Que es el smishing?"
                p1="El smishing es una variante del phishing que utiliza mensajes de texto (SMS) para engañar a los usuarios y hacer que revelen información personal o realicen acciones perjudiciales. Los atacantes envían mensajes que parecen provenir de fuentes legítimas, como bancos o servicios de mensajería, solicitando que el usuario haga clic en un enlace o proporcione información sensible."
                p2="Al igual que el phishing tradicional, el objetivo del smishing es robar datos personales o financieros."
                src="/phishing/smishing.webp" />
        },
        {
            id: 2,
            icon: Icons.call,
            ...
            child: <ModalInfoContent title="¿Que es el vishing?"
                p1="El vishing, o phishing por voz, es una técnica de fraude que utiliza llamadas telefónicas para engañar a los usuarios y hacer que revelen información personal o financiera. Los atacantes suelen hacerse pasar por representantes de empresas legítimas, como bancos o servicios gubernamentales, y solicitan información sensible bajo pretextos falsos."
                p2="El vishing puede ser muy convincente, ya que los atacantes pueden utilizar técnicas de ingeniería social para ganar la confianza del usuario."
                src="/phishing/vishing.webp" />
        },
        {
            id: 3,
            icon: Icons.target,
            ...
            child: <ModalInfoContent title="¿Que es el vishing?"
                p1="El vishing, o phishing por voz, es una técnica de fraude que utiliza llamadas telefónicas para engañar a los usuarios y hacer que revelen información personal o financiera. Los atacantes suelen hacerse pasar por representantes de empresas legítimas, como bancos o servicios gubernamentales, y solicitan información sensible bajo pretextos falsos."
                p2="El vishing puede ser muy convincente, ya que los atacantes pueden utilizar técnicas de ingeniería social para ganar la confianza del usuario."
                src="/phishing/spear_phishing.webp" />
        },
        {
            id: 4,
            icon: Icons.web,
            ...
            child: (
                <ModalInfoContent
                    title="¿Qué es el pharming?"
                    p1="El pharming es una técnica de ataque que redirige a los usuarios de un sitio web legítimo a un sitio web falso sin su conocimiento. Esto se logra manipulando el sistema de nombres de dominio (DNS) o mediante malware que modifica la configuración del navegador. Una vez en el sitio falso, los usuarios pueden ser engañados para que ingresen información personal o financiera, creyendo que están interactuando con un sitio legítimo."
                    p2="El pharming es particularmente peligroso porque puede afectar a muchos usuarios al mismo tiempo y no requiere que el usuario haga clic en un enlace malicioso."
                    src="/phishing/pharming.webp"
                />
            )
        },
        {
            ...
            child: (
                <ModalInfoContent
                    title="¿Qué es el phishing en redes sociales?"
                    p1="El phishing en redes sociales es una técnica que utiliza plataformas de redes sociales para engañar a los usuarios y hacer que revelen información personal o hagan clic en enlaces maliciosos. Los atacantes pueden crear perfiles falsos o enviar mensajes directos que parecen provenir de amigos o contactos legítimos. Estos mensajes a menudo contienen enlaces a sitios web falsos o solicitudes de información personal."
                    p2="Dado que las redes sociales son ampliamente utilizadas, el phishing en estas plataformas puede alcanzar a un gran número de personas rápidamente."
                    src="/phishing/social_media.webp"
                />
            )
        }
    ]
...
export function ModalInfoContent({ title, p1, p2, src }: { title: string, p1: string, p2?: string, src: string }) {
    return (
        <div className="flex md:flex-row flex-col gap-2">
            <div className="flex-2 flex flex-col">
                ...
                {(p2 && p2.trim()) &&
                    <>
                        <br />
                        <p className="text-base">El objetivo principal del phishing es robar información sensible para realizar fraudes financieros o comprometer la seguridad de las cuentas del usuario.</p>
                    </>
                }
            </div>
            <div className="flex-1">
                <img src={src} alt={title} className="max-h-[20vh] md:max-h-[40vh]" />
            </div>
        </div>
    )
}